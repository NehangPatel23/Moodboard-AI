...
export const HELP_SECTIONS: HelpSection[] = [
  ...
  },
  {
    ...
    bullets: [
      ...
      'Your name appears on Discover and public boards. Workspace name, tagline, and avatar customize the sidebar.',
      'Upload a profile photo or pick an emoji avatar; crop round photos before upload. Accent color applies to emoji and initials avatars.',
    ],
